    ...
    <section className="hero-section d-flex align-items-center text-center">
      <div className="container">
        ...
        <div className="social-icons mt-5">
          ...
          <a href="#" className="icon-link mx-2 fs-4"><i className="bi bi-linkedin"></i></a>
          <a href="#" className="icon-link mx-2 fs-4"><i className="bi bi-instagram"></i></a>
          <a href="#" className="icon-link mx-2 fs-4"><i className="bi bi-github"></i></a>
        </div>
      </div>
    </section>
  );
